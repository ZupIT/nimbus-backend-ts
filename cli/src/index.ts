...
program
  .name('nimbus-ts')
  .description('A command-line tool that helps using Nimbus Backend TypeScript by initializing a project and creating new files from templates.')
  .usage('[global options] command')
  .version('1.0.0')

program
  .command('new')
  .description('Creates a new Nimbus Backend TypeScript project.')
